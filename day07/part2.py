...
def calculate(input_text):
    ...
    for hand, bid in hands:
        ...
        if s == 1:  # High card
            if num_jokers == 1:
                # Can only be 1 or 0 jokers. If 1, it can match with any other
            ...
            if num_pairs == 1:
                if num_jokers > 0:
                    # 0, 1 or 2 jokers. If 1, it matches with the pair.
                    # If 2, they match with any other card
            ...
            if num_jokers > 0:
                by_type[FIVE_OF_A_KIND].append((hand, bid))  # Five of a kind
            else:
